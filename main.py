...
def main():
    with open('/home/tzag/Nir/me/config.yaml') as f:
    ...
    driver = webdriver.Chrome(executable_path = r'/home/tzag/Nir/me/chromedriver', options=option)
    ...
    driver.find_element(By.ID, "password").send_keys(cfg['p'])
